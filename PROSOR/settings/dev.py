...
DATABASES = {
    'default': {
        ...
        'NAME': config.get('POSTGRE_DB_DETAIL', 'DATABASE_NAME'),
        'USER': config.get('POSTGRE_DB_DETAIL', 'DATABASE_USER'),
        'PASSWORD': config.get('POSTGRE_DB_DETAIL', 'DATABASE_PASSWORD'),
        'HOST': config.get('POSTGRE_DB_DETAIL', 'DATABASE_HOST'),
        'PORT':  config.get('POSTGRE_DB_DETAIL', 'DATABASE_PORT'),
    }
}
